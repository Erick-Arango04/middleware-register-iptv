...
/**
 * <p>Clase Java para catTerminalsVO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="catTerminalsVO"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="responseVO" type="{http://bean.tpsms.tp.com.mx/}responseVO" minOccurs="0"/&gt;
 *         &lt;element name="terminals" type="{http://bean.tpsms.tp.com.mx/}terminalVO" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "catTerminalsVO", propOrder = {
    "responseVO",
    "terminals"
})
public class CatTerminalsVO {

    protected ResponseVO responseVO;
    @XmlElement(nillable = true)
    protected List<TerminalVO> terminals;
    ...
    public List<TerminalVO> getTerminals() {
        if (terminals == null) {
            terminals = new ArrayList<TerminalVO>();
        }
