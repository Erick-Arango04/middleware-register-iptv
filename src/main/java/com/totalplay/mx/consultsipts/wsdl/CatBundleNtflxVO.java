...
/**
 * <p>Clase Java para catBundleNtflxVO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="catBundleNtflxVO"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="bundles" type="{http://bean.tpsms.tp.com.mx/}bundleNtflxVO" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "catBundleNtflxVO", propOrder = {
    "bundles",
    "responseVO"
})
public class CatBundleNtflxVO {

    @XmlElement(nillable = true)
    protected List<BundleNtflxVO> bundles;
     ...
     * 
     */
    public List<BundleNtflxVO> getBundles() {
        if (bundles == null) {
            bundles = new ArrayList<BundleNtflxVO>();
        }
        return this.bundles;
    }
