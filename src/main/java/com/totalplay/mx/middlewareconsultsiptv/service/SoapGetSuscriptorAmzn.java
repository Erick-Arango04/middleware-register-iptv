...
@Service
public class SoapGetSuscriptorAmzn {
	...
	public String getResponseSuscriptorAmzn(){
		...
		GetSuscriptorAmznResponse response = (GetSuscriptorAmznResponse) 
				soapClient.getResponse(objectFactory.createGetSuscriptorAmzn(getSuscriptorAmzn));
